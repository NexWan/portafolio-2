          ...
          <h1 className="text-xl text-center">{current}</h1>
            ...
            <nav className="flex items-end justify-end mr-5 w-1/3">
                <ul className="header__nav-list flex flex-row justify-end items-end space-x-10">
                    ...
                    <li className="hover:scale-105 ">
                        <Link to="projects" smooth={true} duration={500} activeClass="!text-red text-xl" spy={true} onSetInactive={() => { setIsActive(false)}} onSetActive={() => setIsActive(true)} className={`hover:cursor-pointer hover:scale-105 transition-all`}>Projects</Link>
                    </li>
                    <li className="hover:scale-105 ">
